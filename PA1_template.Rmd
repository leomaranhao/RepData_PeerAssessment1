...
### Do these values differ from the estimates from the first part of the assignment? What is the impact of imputing missing data on the estimates of the total daily number of steps?  
    ERROOOO!!!!
**These values differ from the estimates from the first part of the assignment. As the imputing data considered the mean step value for the interval of the day and not the date itself, when calculation the mean and the median values by day, it caused a difference in the results.**
